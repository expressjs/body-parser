...
describe('isValidJsonCharset(charset)', () => {
  ...
  it('should return true for UTF-8/UTF-16/UTF-32 case-insensitively', () => {
    assert.equal(isValidJsonCharset('utf-8'), true)
    assert.equal(isValidJsonCharset('UTF-8'), true)
    assert.equal(isValidJsonCharset('Utf-8'), true)

    assert.equal(isValidJsonCharset('utf-16'), true)
    assert.equal(isValidJsonCharset('UTF-16'), true)

    assert.equal(isValidJsonCharset('utf-32'), true)
    assert.equal(isValidJsonCharset('UTF-32'), true)
  })

  it('should return false for other utf-* labels (not allowed by JSON RFC)', () => {
...
describe('isValidUrlencodedCharset(charset)', () => {
  ...
  it('should return true for UTF-8 and ISO-8859-1 case-insensitively', () => {
