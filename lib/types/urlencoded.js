 ...
 * the parsing options
 */
function createBodyDecoder (queryparse, charset, utf8Sentinel, interpretNumericEntities) {
...
function urlencoded (options) {
  ...
  return function urlencodedParser (req, res, next) {
    ...
    // read
    read(req, res, next, createBodyDecoder(queryparse, charset, utf8Sentinel, interpretNumericEntities), debug, {
      encoding: charset,
      inflate: inflate,
      limit: limit,
      verify: verify
